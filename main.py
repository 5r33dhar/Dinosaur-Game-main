...
pygame.init()
pygame.font.init()  # make sure the font module is ready

BASE_DIR = os.path.dirname(__file__)
FONT_PATH = os.path.join(BASE_DIR, "assets", "noPressStart2P-Regular.ttf")

# Try custom font first, fall back to system font if not found
try:
...
class Dino(pygame.sprite.Sprite):
    def __init__(self, x_pos, y_pos):
        ...
        self.running_sprites.append(pygame.transform.scale(
            pygame.image.load("Dinosaur-Game-main/assets/Dino1.png"), (80, 100)))
        self.running_sprites.append(pygame.transform.scale(
            pygame.image.load("Dinosaur-Game-main/assets/Dino2.png"), (80, 100)))

        self.ducking_sprites.append(pygame.transform.scale(
            pygame.image.load(f"Dinosaur-Game-main/assets/DinoDucking1.png"), (110, 60)))
        self.ducking_sprites.append(pygame.transform.scale(
            pygame.image.load(f"Dinosaur-Game-main/assets/DinoDucking2.png"), (110, 60)))
    ...
    def __init__(self, x_pos, y_pos):
        ...
        for i in range(1, 7):
            current_sprite = pygame.transform.scale(
                pygame.image.load(f"Dinosaur-Game-main/assets/cacti/cactus{i}.png"), (100, 100))
    ...
    def __init__(self):
        ...
        self.sprites.append(
            pygame.transform.scale(
                pygame.image.load("Dinosaur-Game-main/assets/Ptero1.png"), (84, 62)))
        self.sprites.append(
            pygame.transform.scale(
                pygame.image.load("Dinosaur-Game-main/assets/Ptero2.png"), (84, 62)))
        self.current_image = 0
...
ground = pygame.image.load("Dinosaur-Game-main/assets/ground.png")
ground = pygame.transform.scale(ground, (1280, 20))
ground_x = 0
ground_rect = ground.get_rect(center=(640, 400))
cloud = pygame.image.load("Dinosaur-Game-main/assets/cloud.png")
